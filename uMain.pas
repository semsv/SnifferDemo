...
uses
  ...
  Dialogs, StdCtrls, WinSock, shellApi;
...
type
  ...
  TfrmMain = class(TForm)
    ...
    procedure cbInterfacesDropDown(Sender: TObject);
  private
...
procedure TfrmMain.FormCreate(Sender: TObject);
 const GlobMapID = 'MySnifferDemo_Run_tmp';
 type
 TShareInf = record
   Field : DWORD;
 end;
...
procedure TfrmMain.cbInterfacesDropDown(Sender: TObject);
begin
 cbInterfaces.Clear;
ReadLanInterfaces;
end;
